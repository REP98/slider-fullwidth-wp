<div class="spfp-rp dir-y">
	<div class="top-left spfp-logo">
		<img data-src="{{$logo}}" class="lazyload" loading="lazy" alt="">
	</div>
	@include('menu')
	@include('menumovil')
	...
	@php
		$href = array_keys($idSection);
	@endphp
	<a href="#{{$href[1]}}" data-mt-duration="1000" class="plyr__control btn_scroll_btn bottom-left">
